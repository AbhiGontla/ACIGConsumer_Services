...
namespace Core.Api
{
    public class OSClaims:BaseEntity
    {		
		...
		public string CL_PROVIDER_TYPE { get; set; }
		public string CL_PROVIDER_NO { get; set; }
		...
		public string CL_ACCIDT { get; set; }
		...
		public string CL_SYSDATE { get; set; }
	...
	public class OSClaimsResponse
	{
		public string responseCode { get; set; }
		public string responseMessage { get; set; }
		public List<OSClaims> responseData { get; set; }
	}
